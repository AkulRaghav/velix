module github.com/velix/backend/services/notifier
...
require (
	...
	github.com/velix/backend/pkg/velixctx v0.0.0 // indirect
...
replace github.com/velix/backend/pkg/velixctx => ../../pkg/velixctx
